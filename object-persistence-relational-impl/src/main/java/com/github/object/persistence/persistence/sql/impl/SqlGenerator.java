...
import com.github.object.persistence.api.utils.StringUtils;
...
public class SqlGenerator {
     ...
     * @return сгенерированный SQL-код
     */
    String insertRecord(Class<?> entity, Set<String> columnNames) {
    ...
    String insertRecords(Class<?> recordItemClass, int sizeOfItems, Set<String> columnNames) {
